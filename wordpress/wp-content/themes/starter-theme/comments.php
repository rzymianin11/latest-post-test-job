...
<div id="comments">
	...
	?>
		<h2 id="comments-title">
			<?php
				esc_html_e( 'No Comments yet!', 'starter-theme' );
			?>
		</h2>
	<?php
		endif;
		...
		<h2 id="comments-title">
			<?php
				...
				if ( '1' === $comments_number ) {
					printf( _x( 'One Reply to &ldquo;%s&rdquo;', 'comments title', 'starter-theme' ), get_the_title() );
				} else {
					printf(
	...
	?>
		<h2 id="comments-title" class="nocomments"><?php esc_html_e( 'Comments are closed.', 'starter-theme' ); ?></h2>
	<?php
		endif;
